        ...
        this.shadowRoot.innerHTML = /*html*/ `
            ...
            <header class="header">
               <div class="image-container">    
                 <slot name="card-image">Default text</slot>
               </div>
                <div class="svg-container">
                <svg width="100%" height="100%" viewBox="0 0 418 68" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <footer>
                <slot name="card-author">Default text</slot>
           </footer>
          `
    }
...
globalThis.customElements.define("main-card", Card);